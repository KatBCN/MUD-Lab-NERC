...
def extract_features(tokens) :
   ...
   for k in range(0,len(tokens)):
      ...
      # add feature to indicate DrugBank dictionary value
      if t in dict_DrugBank:
         tokenFeatures.append("dictDB="+dict_DrugBank[t])
...
# adding drug bank dictionary to program
dict_DrugBank = {}
